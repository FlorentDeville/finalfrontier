...
namespace Assets.Script.Core.Math
{
    public class FD_Math
    {
        public static float GetSignedAngle(Vector3 _from, Vector3 _to, Vector3 _normal)
        {
            float cos = Vector3.Dot(_from, _to);
            cos = Mathf.Clamp(cos, -1f, 1f);
            Vector3 sin = Vector3.Cross(_from, _to);
            float sinusSign = Vector3.Dot(sin, _normal);
        ...
        /// <summary>
        /// Return the projected normal in a plan. The plan is defined by its normal _normal.
        /// </summary>
        /// <param name="_v"></param>
        /// <param name="_normal"></param>
        /// <returns></returns>
        public static Vector3 GetProjectedVectorOnPlan(Vector3 _v, Vector3 _normal)
        {
            return _v - Vector3.Dot(_v, _normal) * _normal;
        }
